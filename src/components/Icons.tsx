...
export const ScaleIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M12 3v18M8 6l-4 8h8l-4-8zM16 6l-4 8h8l-4-8z" strokeLinecap="round" strokeLinejoin="round"/>
...
export const BookIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <path d="M8 7h8M8 11h8" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const ShieldIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M12 2l8 3v7c0 5-3 9-8 11-5-2-8-6-8-11V5l8-3z" strokeLinecap="round" strokeLinejoin="round"/>
...
export const TrophyIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <path d="M6 4v5c0 3.5 2.5 6 6 6s6-2.5 6-6V4H6z" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M10 15v5M14 15v5M8 20h8" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
